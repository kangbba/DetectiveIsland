...
public static class NodeColors
{
    ...
    public static Color gainItemColor = new Color(0.3f, 0.7f, 0.7f); // Teal
    public static Color modifyPositionColor = new Color(0.9f, 0.9f, 0.4f); // Soft Yellow
    public static Color itemDemandColor = new Color(1.0f, 0.5f, 0.5f); // Soft Red

    public static Color gainPlaceColor = new Color(0.5f, 0.7f, 0.9f); // Soft Light Blue
    public static Color gainFriendshipColor = new Color(0.7f, 0.4f, 0.7f); // Soft Mauve
